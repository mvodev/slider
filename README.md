...
```
 ...
 sliderInstance.update(newSettings); - возможность передать новые настройки в слайдер
 sliderInstance.getSettings(); - возвращает настройки слайдера в виде строки
 sliderInstance.addCallback(callback); - добавляет функцию обратного вызова 
 ...
 sliderInstance.removeCallback(callback); - отменяет подписку на изменения слайдера
 для данной функции обратного вызова

 sliderInstance.destroy(); - удаляет слайдер из DOM дерева
