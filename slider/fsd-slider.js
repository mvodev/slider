...
/*!****************************!*\
  !*** ./utils/Constants.ts ***!
  \****************************/
/*! exports provided: Constants, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _model_defaultSettings__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../model/defaultSettings */ \"./model/defaultSettings.ts\");\n/* harmony import */ var _utils_ClassNaming__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../utils/ClassNaming */ \"./utils/ClassNaming.ts\");\n\n\n\nclass RangeLabel {\n  constructor(settings) {\n    this.labels = [];\n    this.settings = Object.assign(_model_defaultSettings__WEBPACK_IMPORTED_MODULE_0__[\"default\"], settings);\n    this.initComponents();\n  }\n\n  render(settings) {\n    this.settings = Object.assign(this.settings, settings);\n    this.setMinRange(this.settings.min);\n    this.setMaxRange(this.settings.max);\n  }\n\n  getRangeLabel() {\n    return this.rangeLabelContainer;\n  }\n\n  setMinRange(value) {\n    this.minLabel.innerText = `${value}`;\n  }\n\n  setMaxRange(value) {\n    this.maxLabel.innerText = `${value}`;\n  }\n\n  initComponents() {\n    this.rangeLabelContainer = document.createElement('div');\n    this.rangeLabelContainer.classList.add(_utils_ClassNaming__WEBPACK_IMPORTED_MODULE_1__[\"default\"].RANGE_LABEL);\n    this.minLabel = document.createElement('span');\n    this.minLabel.classList.add(_utils_ClassNaming__WEBPACK_IMPORTED_MODULE_1__[\"default\"].RANGE_LABEL_SCALE);\n    this.maxLabel = document.createElement('span');\n    this.maxLabel.classList.add(_utils_ClassNaming__WEBPACK_IMPORTED_MODULE_1__[\"default\"].RANGE_LABEL_SCALE);\n    this.rangeLabelContainer.appendChild(this.minLabel);\n    this.labels.push(this.minLabel);\n    const pivotMark = document.createElement('span');\n    pivotMark.classList.add(_utils_ClassNaming__WEBPACK_IMPORTED_MODULE_1__[\"default\"].RANGE_LABEL_SCALE);\n    this.labels.push(pivotMark);\n    this.rangeLabelContainer.appendChild(pivotMark);\n    this.rangeLabelContainer.appendChild(this.maxLabel);\n    this.labels.push(this.maxLabel);\n  }\n\n  setVertical() {\n    this.getRangeLabel().classList.add(_utils_ClassNaming__WEBPACK_IMPORTED_MODULE_1__[\"default\"].RANGE_LABEL_IS_VERTICAL);\n  }\n\n  setHorizontal() {\n    this.getRangeLabel().classList.remove(_utils_ClassNaming__WEBPACK_IMPORTED_MODULE_1__[\"default\"].RANGE_LABEL_IS_VERTICAL);\n  }\n\n  getLabels() {\n    return this.labels;\n  }\n\n  hideLabels() {\n    this.rangeLabelContainer.classList.add(_utils_ClassNaming__WEBPACK_IMPORTED_MODULE_1__[\"default\"].HIDE_ELEMENT);\n  }\n\n  showLabels() {\n    this.rangeLabelContainer.classList.remove(_utils_ClassNaming__WEBPACK_IMPORTED_MODULE_1__[\"default\"].HIDE_ELEMENT);\n  }\n\n}\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (RangeLabel);\n\n//# sourceURL=webpack:///./view/components/RangeLabel.ts?");
