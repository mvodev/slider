  ...
  setColoredRange(
    ...
    if (viewSettings.isRange) {
      if (viewSettings.isVertical) {
        ...
        this.getColoredRange().style.height = `${(Number.parseInt(thumbTo.style.top, 10)
        ...
        this.getColoredRange().style.width = `${(Number.parseInt(thumbTo.style.left, 10)
      ...
      if (viewSettings.isVertical) {
        this.getColoredRange().style.top = '0%';
        this.getColoredRange().style.width = '100%';
        this.getColoredRange().style.height = `${(Number.parseInt(thumbFrom.style.top, 10)
          + thumbWidthInPercentage * 0.5)}%`;
      } else {
        this.getColoredRange().style.width = `${(Number.parseInt(thumbFrom.style.left, 10)
          + thumbWidthInPercentage * 0.5)}%`;
        this.getColoredRange().style.left = '0%';
        this.getColoredRange().style.top = '0%';
        this.getColoredRange().style.height = '100%';
